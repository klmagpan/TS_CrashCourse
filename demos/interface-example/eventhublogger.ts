import { Globomantics } from './Globomantics.EventHub'; // connects to event hub
import { ILogger } from './ILogger';

export abstract class eventHubLogger implements ILogger // implements: used for interface
{
	title: string;
